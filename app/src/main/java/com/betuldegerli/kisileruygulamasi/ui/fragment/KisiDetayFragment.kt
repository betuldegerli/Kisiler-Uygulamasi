...
import com.betuldegerli.kisileruygulamasi.databinding.FragmentKisiDetayBinding
...
class KisiDetayFragment : Fragment() {
    ...
    override fun onCreateView( inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding.toolbarKisiDetay.title="Kişi Bilgileri Güncelle"


        //ANASAYFA FRAGMENTTEN GEÇİSİ SAĞLAMA VE BİLGİLERİ YAZDIRMA
        val bundle: KisiDetayFragmentArgs by navArgs()
        val gelenKisi=bundle.kisi
        binding.editTextKisiAd.setText(gelenKisi.kisi_ad)
        binding.editTextKisiTel.setText(gelenKisi.kisi_tel)

        //GÜNCELLE BUTONUNA BASINCA KİŞ BİLGİLERİNİN GÜNCELLENMESİ
    ...
    //GÜNCELLE BUTONU İÇİN OLUŞTURULAN FONKSYON
